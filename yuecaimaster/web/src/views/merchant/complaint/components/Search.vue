  ...
  <div class="p-4 card">
    <el-form label-width="100px" class="demo-form-inline">
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="状态：" v-if="$parent.comopnent == 'Record'">
        ...
        <el-col :span="6">
          <el-form-item label="审核时间 " v-if="$parent.comopnent == 'Record'">
            <el-date-picker
      ...
      <el-row>
        <el-col :span="18" :offset="6" class="text-right">
  ...
  methods: {
    searchFunc: _.throttle(
      function() {
        ...
        this.searchForm.date2 = this.searchForm.date2 || []
