    ...
    <div v-show="$route.meta.showRole">
      ...
      <div class="card">
        <tabs :tabList="tabList" :comopnent.sync="component">
          <template v-slot:add>
            <el-button v-show="component == 'AllRecommend'" type="primary" size="small" @click="addFunc">新建</el-button></template
          >
        </tabs>
...
import AllRecommend from "./components/AllRecommend.vue"
export default {
  components: { HomePage, AllRecommend, Search },
  data() {
    return {
      component: "HomePage",
      tabList: [
        { text: "首页展示", component: "HomePage" },
        { text: "所有推荐", component: "AllRecommend" },
      ],
    }
  },
  methods: {
